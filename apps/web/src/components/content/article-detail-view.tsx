      ...
      <div className="p-4 border-b border-border/50 flex flex-wrap items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="font-medium text-foreground text-sm break-words">{title}</p>
        ...
        <a
          href={url}
          download
          className="inline-flex items-center gap-2 min-h-11 px-4 py-2 bg-villiers-blue text-white rounded-lg text-sm font-medium hover:bg-villiers-blue/90 transition-colors"
        >
