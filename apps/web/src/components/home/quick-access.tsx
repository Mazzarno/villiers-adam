...
const quickAccessItems = [
  {
    icon: FileText,
    label: 'Démarches',
    description: 'État civil, urbanisme, attestations',
    href: '/demarches',
  ...
  },
  {
    icon: Calendar,
    label: 'Événements',
    description: 'Agenda et rendez-vous locaux',
    href: '/evenements',
  ...
  },
  {
    icon: Newspaper,
    label: 'Actualités',
    description: 'Infos communales et alertes',
    href: '/actualites',
  ...
  },
  {
    ...
    description: 'Urgences, déchets, services',
  ...
  },
  {
    icon: Bus,
    label: 'Transports',
    description: 'Bus, mobilité, scolaire',
    href: '/transports',
    accent: 'villiers-gold',
  },
  {
  ...
  },
  {
    ...
    description: 'Menus et inscriptions cantine',
    href: '/ecole/restauration-scolaire',
    accent: 'villiers-blue',
  },
  {
    icon: Phone,
    label: 'Contact',
    description: 'Joindre la mairie',
    href: '/contact',
    accent: 'villiers-gold',
  },
];
